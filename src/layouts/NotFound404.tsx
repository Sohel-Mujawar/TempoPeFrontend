...
const NotFound404: React.FC = () => {
  return (
    <section className="dark:bg-gray-900 grid h-screen place-content-center bg-white dark:bg-meta-4">
      <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
        <div className="mx-auto max-w-screen-sm text-center">
          <h1 className="mb-4 text-7xl font-extrabold tracking-tight dark:text-white lg:text-9xl">
            404
          </h1>
          <p className="mb-4 text-3xl font-bold tracking-tight dark:text-white md:text-4xl">
            Something&apos;s missing.
          </p>
